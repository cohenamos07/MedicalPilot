 ...
 * תפקיד: אימות ידני ולמידה — אירועים רפואיים שחולצו על ידי S09
 * קריאה:  גליונות יעד של S09 (יומן_אירועים_רפואי, תרופות_קבועות, יומן_מצב_רפואי,
 *          בדיקות_דם, בדיקות_גנטיות, הנחיות_רפואיות_ומשימות)
 *          ניהול_מיילים — לשליפת TXT_URL לפי File_ID
 * כתיבה:  S10_למידה_רפואי | גליון היעד הפעיל (עדכון שדות)
 * תלוי ב: S10_Sidebar.html | COLUMN_MAP.gs v2.6.0
 */
